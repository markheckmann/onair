...
cond.panel.bertin <- 
  conditionalPanel(condition="input.level1=='bertin_standard'",
                   ...
                   numericInput("bertin_standard_ylim", "Size element region", .6, min = 0, max = 1,
                                step = .05),
                   span(selectInput("bertin_standard_color_left", "Color left pole", colors.all, "white"),
                        selectInput("bertin_standard_color_right", "Color right pole", colors.all, "darkblue")
                   )        
  )
                   ...
                   tabsetPanel(
                     ...
                     tabPanel("Transforms",
                              ...
                              selectInput("biplot_12_center", "Centering", 
                                          choices.center, names(choices.center)[2]),
                              selectInput("biplot_12_normalize", "Normalize", 
                                          choices.normalize, names(choices.normalize)[1]),
                     ...
                     tabPanel("Colors",
                              h5("Element colors"),
                              selectInput("biplot_12_e_point_col", "Symbol", colors.all, "black"),
                              selectInput("biplot_12_e_label_col", "Label", colors.all, "black"),
                              h5("Constructs colors"),
                              selectInput("biplot_12_c_point_col", "Symbol", colors.all, "black"),
                              selectInput("biplot_12_c_label_col", "Label", colors.all, "black") 
                     ),
                     id="todo")               
  ) 
